...
Status: MT-0, MT-1 and MT-2 complete. MT-3 is in progress. 26/56 complete, 30 pending. MT-3.2 is complete; MT-3.7 is pending.

Last completed point: MT-3.2 - Dynamic CMS, media and presentation services

Next pending point: MT-3.7 - Website operating mode publication
