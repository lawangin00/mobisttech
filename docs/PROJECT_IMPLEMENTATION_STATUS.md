...
Status: MT-0 and MT-1 complete. MT-2 is in progress. 20/56 complete, 36 pending. MT-2.13 is complete; MT-2.14 is pending.

Last completed point: MT-2.13 - Trade-in and buyback services

Next pending point: MT-2.14 - Promotion and coupon services
