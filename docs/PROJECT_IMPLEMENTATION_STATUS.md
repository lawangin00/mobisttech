...
Status: MT-0 and MT-1 complete. MT-2 is in progress. 16/56 complete, 40 pending. MT-2.10 is complete; MT-2.11 is not started.

Last completed point: MT-2.10 - Stocktake and cycle-count services
