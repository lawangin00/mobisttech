...
Status: MT-0, MT-1 and MT-2 complete. MT-3 is in progress. 30/56 complete, 26 pending. No point is currently In Progress.

Last completed point: MT-3.9 - Customer engagement and notification services

Next pending point: MT-3.3 - Audit, configuration, backups and integrations
