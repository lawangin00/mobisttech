...
## Development evidence supersession (25-Sep-2026)

The original per-file/route OPEN text above describes the 24-Sep initial mapping, not the 25-Sep final target state. `MT-7.5_W06_DEVELOPMENT_CLOSURE_2026-09-25.md` ties the approved fresh-business target contracts to current CMS PHP 9/9, genuine protected Admin/Next joined Edge 7/7 and tested guided navigation editor/preview, five-section ordered homepage, editable header/footer, separate standard/wide managed templates with protected drafts, scoped published promotion, Software media/SEO/revision/rollback/archive, permissions/modes/collision/URL sanitization. The former independent legacy admin HTML URLs remain retired in favor of existing unified Admin revisions; 72/72 and 45/45 mean disposition coverage, not identical behavior/test count or copied legacy data. 19/W06 development DONE only; separate 20/W07 and final release gates remain pending.
