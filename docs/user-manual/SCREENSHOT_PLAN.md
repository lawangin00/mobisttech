...
|---|---|---|---|---|---|
| S01 | Sign-in | Admin login | Admin sign-in | none | Pending |
| S02 | POS home | /internal/admin/pos | Active outlet + permission-aware navigation | assigned Admin | Pending |
| S03 | Sales | POS / Sales | Cart + authoritative totals/payment editor | shop.sales | Pending |
| S04 | Split tender | POS / Sales | multiple tenders + Remaining | shop.sales | Pending |
| S05 | Invoice | Invoices & customers | historical invoice + Preview/Print/Save/Email/WhatsApp | shop.invoices | Pending |
| S06 | Inventory | POS / Inventory | product/unit/device configuration | shop.inventory | Pending |
...
| S12 | Platform Admin | /internal/admin/platform | header + protected configuration cards | scoped Admin | Pending |
| S13 | Team Members | Platform Administration | role/outlet assignment | team-members.manage | Pending |
| S14 | Website mode | Platform Administration | mode draft/preview/publish | website.settings/manage mode permissions | Pending |
| S15 | CMS/navigation | Platform Administration | managed navigation + footer | website.navigation.manage | Pending |
| S16 | Website media/SEO | Platform Administration | media + SEO controls | website.media/seo.manage | Pending |
| S17 | Legal policy | Platform Administration | policy draft/review state; no final unapproved text | website.content.manage | Pending |
| S18 | Website commerce | /internal/admin/website-commerce | order/review admin | website.orders.manage | Pending |
| S19 | Payment settings | Website payment settings | four fixed channels, external OFF state | website.payments.manage | Pending |
| S20 | Digital Operations | /internal/admin/digital-operations | leads/projects/proposals | relevant digital permissions | Pending |
| S21 | Software Product | Platform Administration | private software preview/release workflow | content/publish permissions | Pending |
| S22 | Integrations | /internal/admin/settings/integrations | safe masked/disconnected state | integration permission | Pending |
| S23 | Backup | protected backup interface | history/create/download/delete controls | backups.manage | Pending |
| S24 | Data Reset | /internal/admin/reset-administration | dry-run preview + warning | system.reset.preview | Pending |
