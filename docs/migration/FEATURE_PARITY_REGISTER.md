...
Source coverage: 28 tracked files; 0 resolved routes. Target owner: tools/mobist-control single Windows application. Gates: MT-6.2, MT-6.3. Target status: Pending.
