...
Source coverage: 37 tracked files; 0 resolved routes. Target owner: backend tests, website Playwright and .github monorepo CI. Gates: MT-7.1, MT-7.2, MT-7.3, MT-7.5. Target status: In Progress (MT-7.1, MT-7.2 and MT-7.3 complete; MT-7.5 pending).
...
Source coverage: 178 tracked files; 4 resolved routes. Target owner: backend foundation, website build contracts and .github. Gates: MT-1.2, MT-1.3, MT-2.1, MT-7.3. Target status: Complete.
