...
assert len(routes['previous_exact_route_dispositions'])==275 and len(routes['pending_exact_route_review'])==41
...
print('H01_DOCUMENT_AUTHORITY_AND_TRACE_GUARD_PASS 1224 files 316 source routes 275 exact route rows 41 pending 45 verified provenance originals P01/Q01 OPEN')
