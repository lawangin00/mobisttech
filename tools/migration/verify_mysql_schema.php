...
if (! in_array($mode, ['payments', 'cash', 'trade-in', 'promotion', 'loyalty', 'repair', 'documents', 'cms', 'digital-services', 'projects', 'engagement', 'operations', 'reset', 'api'], true)) {
    $checkpointPermissions = array_values(array_diff($checkpointPermissions, $paymentPermissions));
}
if (! in_array($mode, ['documents', 'cms', 'digital-services', 'projects', 'engagement', 'operations', 'reset', 'api'], true)) {
...
if (in_array($mode, ['identity', 'addendum', 'sales', 'warranty', 'admin-google', 'orders', 'team-members', 'procurement', 'stocktake', 'transfer', 'payments', 'cash', 'trade-in', 'promotion', 'loyalty', 'repair', 'documents', 'cms', 'digital-services', 'projects', 'engagement', 'operations', 'reset', 'api'], true)) {
...
if (in_array($mode, ['warranty', 'admin-google', 'orders', 'team-members', 'procurement', 'stocktake', 'transfer', 'payments', 'cash', 'trade-in', 'promotion', 'loyalty', 'repair', 'documents', 'cms', 'digital-services', 'projects', 'engagement', 'operations', 'reset', 'api'], true)) {
...
if (in_array($mode, ['admin-google', 'orders', 'team-members', 'procurement', 'stocktake', 'transfer', 'payments', 'cash', 'trade-in', 'promotion', 'loyalty', 'repair', 'documents', 'cms', 'digital-services', 'projects', 'engagement', 'operations', 'reset', 'api'], true)) {
...
if (in_array($mode, ['team-members', 'procurement', 'stocktake', 'transfer', 'payments', 'cash', 'trade-in', 'promotion', 'loyalty', 'repair', 'documents', 'cms', 'digital-services', 'projects', 'engagement', 'operations', 'reset', 'api'], true)) {
...
if (in_array($mode, ['stocktake', 'transfer', 'payments', 'cash', 'trade-in', 'promotion', 'loyalty', 'repair', 'documents', 'cms', 'digital-services', 'projects', 'engagement', 'operations', 'reset', 'api'], true)) {
...
if (in_array($mode, ['transfer', 'payments', 'cash', 'trade-in', 'promotion', 'loyalty', 'repair', 'documents', 'cms', 'digital-services', 'projects', 'engagement', 'operations', 'reset', 'api'], true)) {
...
if (in_array($mode, ['cash', 'trade-in', 'promotion', 'loyalty', 'repair', 'documents', 'cms', 'digital-services', 'projects', 'engagement', 'operations', 'reset', 'api'], true)) {
...
if (in_array($mode, ['promotion', 'loyalty', 'repair', 'documents', 'cms', 'digital-services', 'projects', 'engagement', 'operations', 'reset', 'api'], true)) {
...
if (in_array($mode, ['loyalty', 'repair', 'documents', 'cms', 'digital-services', 'projects', 'engagement', 'operations', 'reset', 'api'], true)) {
...
if (in_array($mode, ['repair', 'documents', 'cms', 'digital-services', 'projects', 'engagement', 'operations', 'reset', 'api'], true)) {
...
if (in_array($mode, ['cms', 'digital-services', 'projects', 'engagement', 'operations', 'reset', 'api'], true)) {
...
if (in_array($mode, ['digital-services', 'projects', 'engagement', 'operations', 'reset', 'api'], true)) {
...
if (in_array($mode, ['projects', 'engagement', 'operations', 'reset', 'api'], true)) {
...
if (in_array($mode, ['engagement', 'operations', 'reset', 'api'], true)) {
...
if (in_array($mode, ['operations', 'reset', 'api'], true)) {
...
if (in_array($mode, ['reset', 'api'], true)) {
...
if ($mode === 'api') {
    $requiredIndexes = [
        'product_listings' => ['mt34_catalogue_page', 'mt34_catalogue_search'],
        'products' => ['mt34_product_category'],
        'orders' => ['mt34_customer_orders'],
        'digital_services' => ['mt34_public_services'],
        'software_releases' => ['mt34_public_releases'],
    ];
    foreach ($requiredIndexes as $table => $names) {
        $actualIndexes = array_column($schema->getIndexes($table), 'name');
        foreach ($names as $name) {
            if (! in_array($name, $actualIndexes, true)) {
                throw new RuntimeException('Missing MT-3.4 API index: '.$table.'.'.$name);
            }
        }
    }
}

if (in_array($mode, ['trade-in', 'promotion', 'loyalty', 'repair', 'documents', 'cms', 'digital-services', 'projects', 'engagement', 'operations', 'reset', 'api'], true)) {
...
foreach ($actual as $table) {
    ...
    $seedRows = in_array($mode, ['admin-google', 'orders', 'team-members', 'procurement', 'stocktake', 'transfer', 'payments', 'cash', 'trade-in', 'promotion', 'loyalty', 'repair', 'documents', 'cms', 'digital-services', 'projects', 'engagement', 'operations', 'reset', 'api'], true) ? ['business_profiles' => 1, 'integration_connections' => 2] : [];
    if (in_array($mode, ['team-members', 'procurement', 'stocktake', 'transfer', 'payments', 'cash', 'trade-in', 'promotion', 'loyalty', 'repair', 'documents', 'cms', 'digital-services', 'projects', 'engagement', 'operations', 'reset', 'api'], true)) {
...
echo json_encode(['mode' => $mode, 'result' => 'PASS', 'database' => $db->db, 'port' => (int) $db->port,
    ...
    'business_rows' => 0, 'canonical_seed_rows' => in_array($mode, ['team-members', 'procurement', 'stocktake', 'transfer', 'payments', 'cash', 'trade-in', 'promotion', 'loyalty', 'repair', 'documents', 'cms', 'digital-services', 'projects', 'engagement', 'operations', 'reset', 'api'], true)
        ? 3 + count($checkpointPermissions) + 12 + DB::table('role_permissions')->count() + (in_array($mode, ['documents', 'cms', 'digital-services', 'projects', 'engagement', 'operations', 'reset', 'api'], true) ? 6 : 0)
