...
$mode = $argv[1] ?? '';
if (! in_array($mode, ['cms', 'digital-services', 'projects', 'engagement', 'operations', 'reset', 'documents', 'repair', 'loyalty', 'promotion', 'trade-in', 'cash', 'payments', 'transfer', 'stocktake', 'procurement', 'team-members', 'orders', 'admin-google', 'warranty', 'sales', 'addendum', 'identity', 'shared', 'runtime'], true)) {
    throw new RuntimeException('Expected cms, digital-services, projects, engagement, operations, reset, documents, repair, loyalty, promotion, trade-in, cash, payments, transfer, stocktake, procurement, team-members, orders, admin-google, warranty, sales, addendum, identity, shared or runtime verification mode.');
}
...
if (! in_array($mode, ['payments', 'cash', 'trade-in', 'promotion', 'loyalty', 'repair', 'documents', 'cms', 'digital-services', 'projects', 'engagement', 'operations', 'reset'], true)) {
    $checkpointPermissions = array_values(array_diff($checkpointPermissions, $paymentPermissions));
}
if (! in_array($mode, ['documents', 'cms', 'digital-services', 'projects', 'engagement', 'operations', 'reset'], true)) {
...
if (in_array($mode, ['identity', 'addendum', 'sales', 'warranty', 'admin-google', 'orders', 'team-members', 'procurement', 'stocktake', 'transfer', 'payments', 'cash', 'trade-in', 'promotion', 'loyalty', 'repair', 'documents', 'cms', 'digital-services', 'projects', 'engagement', 'operations', 'reset'], true)) {
...
if (in_array($mode, ['addendum', 'sales', 'warranty', 'admin-google', 'orders', 'team-members', 'procurement', 'stocktake', 'transfer', 'payments', 'cash', 'trade-in', 'promotion', 'loyalty', 'repair', 'documents', 'cms', 'digital-services', 'projects', 'engagement', 'operations', 'reset'], true)) {
...
if (in_array($mode, ['sales', 'warranty', 'admin-google', 'orders', 'team-members', 'procurement', 'stocktake', 'transfer', 'payments', 'cash', 'trade-in', 'promotion', 'loyalty', 'repair', 'documents', 'cms', 'digital-services', 'projects', 'engagement', 'operations', 'reset'], true)) {
...
if (in_array($mode, ['warranty', 'admin-google', 'orders', 'team-members', 'procurement', 'stocktake', 'transfer', 'payments', 'cash', 'trade-in', 'promotion', 'loyalty', 'repair', 'documents', 'cms', 'digital-services', 'projects', 'engagement', 'operations', 'reset'], true)) {
...
if (in_array($mode, ['admin-google', 'orders', 'team-members', 'procurement', 'stocktake', 'transfer', 'payments', 'cash', 'trade-in', 'promotion', 'loyalty', 'repair', 'documents', 'cms', 'digital-services', 'projects', 'engagement', 'operations', 'reset'], true)) {
...
if (in_array($mode, ['orders', 'team-members', 'procurement', 'stocktake', 'transfer', 'payments', 'cash', 'trade-in', 'promotion', 'loyalty', 'repair', 'documents', 'cms', 'digital-services', 'projects', 'engagement', 'operations', 'reset'], true)) {
...
if (in_array($mode, ['team-members', 'procurement', 'stocktake', 'transfer', 'payments', 'cash', 'trade-in', 'promotion', 'loyalty', 'repair', 'documents', 'cms', 'digital-services', 'projects', 'engagement', 'operations', 'reset'], true)) {
...
if (in_array($mode, ['procurement', 'stocktake', 'transfer', 'payments', 'cash', 'trade-in', 'promotion', 'loyalty', 'repair', 'documents', 'cms', 'digital-services', 'projects', 'engagement', 'operations', 'reset'], true)) {
...
if (in_array($mode, ['stocktake', 'transfer', 'payments', 'cash', 'trade-in', 'promotion', 'loyalty', 'repair', 'documents', 'cms', 'digital-services', 'projects', 'engagement', 'operations', 'reset'], true)) {
...
if (in_array($mode, ['transfer', 'payments', 'cash', 'trade-in', 'promotion', 'loyalty', 'repair', 'documents', 'cms', 'digital-services', 'projects', 'engagement', 'operations', 'reset'], true)) {
...
if (in_array($mode, ['cash', 'trade-in', 'promotion', 'loyalty', 'repair', 'documents', 'cms', 'digital-services', 'projects', 'engagement', 'operations', 'reset'], true)) {
...
if (in_array($mode, ['promotion', 'loyalty', 'repair', 'documents', 'cms', 'digital-services', 'projects', 'engagement', 'operations', 'reset'], true)) {
...
if (in_array($mode, ['loyalty', 'repair', 'documents', 'cms', 'digital-services', 'projects', 'engagement', 'operations', 'reset'], true)) {
...
if (in_array($mode, ['repair', 'documents', 'cms', 'digital-services', 'projects', 'engagement', 'operations', 'reset'], true)) {
...
if (in_array($mode, ['cms', 'digital-services', 'projects', 'engagement', 'operations', 'reset'], true)) {
...
if (in_array($mode, ['digital-services', 'projects', 'engagement', 'operations', 'reset'], true)) {
...
if (in_array($mode, ['projects', 'engagement', 'operations', 'reset'], true)) {
...
if (in_array($mode, ['engagement', 'operations', 'reset'], true)) {
...
if (in_array($mode, ['operations', 'reset'], true)) {
...
if ($mode === 'reset') {
    $expected[] = 'reset_operations';
    foreach (['public_id', 'level', 'selected_domains', 'scope_sha256', 'preview_sha256', 'preview', 'record_count', 'file_count',
        'actor_admin_id', 'status', 'backup_record_id', 'object_backup_manifest', 'failure_code', 'started_at', 'completed_at', 'result'] as $column) {
        if (! $schema->hasColumn('reset_operations', $column)) {
            throw new RuntimeException('Missing MT-3.8 reset column: reset_operations.'.$column);
        }
    }
    foreach (['system.reset.preview', 'system.reset.transactional', 'system.reset.business', 'system.reset.factory'] as $permission) {
        if (! DB::table('permission_definitions')->where('code', $permission)->exists()) {
            throw new RuntimeException('Missing MT-3.8 reset permission: '.$permission);
        }
    }
}

if (in_array($mode, ['trade-in', 'promotion', 'loyalty', 'repair', 'documents', 'cms', 'digital-services', 'projects', 'engagement', 'operations', 'reset'], true)) {
...
foreach ($actual as $table) {
    ...
    $seedRows = in_array($mode, ['admin-google', 'orders', 'team-members', 'procurement', 'stocktake', 'transfer', 'payments', 'cash', 'trade-in', 'promotion', 'loyalty', 'repair', 'documents', 'cms', 'digital-services', 'projects', 'engagement', 'operations', 'reset'], true) ? ['business_profiles' => 1, 'integration_connections' => 2] : [];
    if (in_array($mode, ['team-members', 'procurement', 'stocktake', 'transfer', 'payments', 'cash', 'trade-in', 'promotion', 'loyalty', 'repair', 'documents', 'cms', 'digital-services', 'projects', 'engagement', 'operations', 'reset'], true)) {
...
echo json_encode(['mode' => $mode, 'result' => 'PASS', 'database' => $db->db, 'port' => (int) $db->port,
    ...
    'business_rows' => 0, 'canonical_seed_rows' => in_array($mode, ['team-members', 'procurement', 'stocktake', 'transfer', 'payments', 'cash', 'trade-in', 'promotion', 'loyalty', 'repair', 'documents', 'cms', 'digital-services', 'projects', 'engagement', 'operations', 'reset'], true)
        ? 3 + count($checkpointPermissions) + 12 + DB::table('role_permissions')->count() + (in_array($mode, ['documents', 'cms', 'digital-services', 'projects', 'engagement', 'operations', 'reset'], true) ? 6 : 0)
