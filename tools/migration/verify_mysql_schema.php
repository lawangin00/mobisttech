...
$mode = $argv[1] ?? '';
if (! in_array($mode, ['cms', 'digital-services', 'projects', 'engagement', 'documents', 'repair', 'loyalty', 'promotion', 'trade-in', 'cash', 'payments', 'transfer', 'stocktake', 'procurement', 'team-members', 'orders', 'admin-google', 'warranty', 'sales', 'addendum', 'identity', 'shared', 'runtime'], true)) {
    throw new RuntimeException('Expected cms, digital-services, projects, engagement, documents, repair, loyalty, promotion, trade-in, cash, payments, transfer, stocktake, procurement, team-members, orders, admin-google, warranty, sales, addendum, identity, shared or runtime verification mode.');
}
...
if (! in_array($mode, ['payments', 'cash', 'trade-in', 'promotion', 'loyalty', 'repair', 'documents', 'cms', 'digital-services', 'projects', 'engagement'], true)) {
    $checkpointPermissions = array_values(array_diff($checkpointPermissions, $paymentPermissions));
}
if (! in_array($mode, ['documents', 'cms', 'digital-services', 'projects', 'engagement'], true)) {
...
if (in_array($mode, ['identity', 'addendum', 'sales', 'warranty', 'admin-google', 'orders', 'team-members', 'procurement', 'stocktake', 'transfer', 'payments', 'cash', 'trade-in', 'promotion', 'loyalty', 'repair', 'documents', 'cms', 'digital-services', 'projects', 'engagement'], true)) {
...
if (in_array($mode, ['addendum', 'sales', 'warranty', 'admin-google', 'orders', 'team-members', 'procurement', 'stocktake', 'transfer', 'payments', 'cash', 'trade-in', 'promotion', 'loyalty', 'repair', 'documents', 'cms', 'digital-services', 'projects', 'engagement'], true)) {
...
if (in_array($mode, ['sales', 'warranty', 'admin-google', 'orders', 'team-members', 'procurement', 'stocktake', 'transfer', 'payments', 'cash', 'trade-in', 'promotion', 'loyalty', 'repair', 'documents', 'cms', 'digital-services', 'projects', 'engagement'], true)) {
...
if (in_array($mode, ['warranty', 'admin-google', 'orders', 'team-members', 'procurement', 'stocktake', 'transfer', 'payments', 'cash', 'trade-in', 'promotion', 'loyalty', 'repair', 'documents', 'cms', 'digital-services', 'projects', 'engagement'], true)) {
...
if (in_array($mode, ['admin-google', 'orders', 'team-members', 'procurement', 'stocktake', 'transfer', 'payments', 'cash', 'trade-in', 'promotion', 'loyalty', 'repair', 'documents', 'cms', 'digital-services', 'projects', 'engagement'], true)) {
...
if (in_array($mode, ['orders', 'team-members', 'procurement', 'stocktake', 'transfer', 'payments', 'cash', 'trade-in', 'promotion', 'loyalty', 'repair', 'documents', 'cms', 'digital-services', 'projects', 'engagement'], true)) {
...
if (in_array($mode, ['team-members', 'procurement', 'stocktake', 'transfer', 'payments', 'cash', 'trade-in', 'promotion', 'loyalty', 'repair', 'documents', 'cms', 'digital-services', 'projects', 'engagement'], true)) {
...
if (in_array($mode, ['procurement', 'stocktake', 'transfer', 'payments', 'cash', 'trade-in', 'promotion', 'loyalty', 'repair', 'documents', 'cms', 'digital-services', 'projects', 'engagement'], true)) {
...
if (in_array($mode, ['stocktake', 'transfer', 'payments', 'cash', 'trade-in', 'promotion', 'loyalty', 'repair', 'documents', 'cms', 'digital-services', 'projects', 'engagement'], true)) {
...
if (in_array($mode, ['transfer', 'payments', 'cash', 'trade-in', 'promotion', 'loyalty', 'repair', 'documents', 'cms', 'digital-services', 'projects', 'engagement'], true)) {
...
if (in_array($mode, ['cash', 'trade-in', 'promotion', 'loyalty', 'repair', 'documents', 'cms', 'digital-services', 'projects', 'engagement'], true)) {
...
if (in_array($mode, ['promotion', 'loyalty', 'repair', 'documents', 'cms', 'digital-services', 'projects', 'engagement'], true)) {
...
if (in_array($mode, ['loyalty', 'repair', 'documents', 'cms', 'digital-services', 'projects', 'engagement'], true)) {
...
if (in_array($mode, ['repair', 'documents', 'cms', 'digital-services', 'projects', 'engagement'], true)) {
...
if (in_array($mode, ['cms', 'digital-services', 'projects', 'engagement'], true)) {
...
if (in_array($mode, ['digital-services', 'projects', 'engagement'], true)) {
...
if (in_array($mode, ['projects', 'engagement'], true)) {
...
if (in_array($mode, ['trade-in', 'promotion', 'loyalty', 'repair', 'documents', 'cms', 'digital-services', 'projects', 'engagement'], true)) {
...
foreach ($actual as $table) {
    ...
    $seedRows = in_array($mode, ['admin-google', 'orders', 'team-members', 'procurement', 'stocktake', 'transfer', 'payments', 'cash', 'trade-in', 'promotion', 'loyalty', 'repair', 'documents', 'cms', 'digital-services', 'projects', 'engagement'], true) ? ['business_profiles' => 1, 'integration_connections' => 2] : [];
    if (in_array($mode, ['team-members', 'procurement', 'stocktake', 'transfer', 'payments', 'cash', 'trade-in', 'promotion', 'loyalty', 'repair', 'documents', 'cms', 'digital-services', 'projects', 'engagement'], true)) {
...
echo json_encode(['mode' => $mode, 'result' => 'PASS', 'database' => $db->db, 'port' => (int) $db->port,
    ...
    'business_rows' => 0, 'canonical_seed_rows' => in_array($mode, ['team-members', 'procurement', 'stocktake', 'transfer', 'payments', 'cash', 'trade-in', 'promotion', 'loyalty', 'repair', 'documents', 'cms', 'digital-services', 'projects', 'engagement'], true)
        ? 3 + count($checkpointPermissions) + 12 + DB::table('role_permissions')->count() + (in_array($mode, ['documents', 'cms', 'digital-services', 'projects', 'engagement'], true) ? 6 : 0)
