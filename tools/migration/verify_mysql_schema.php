...
$mode = $argv[1] ?? '';
if (! in_array($mode, ['shared', 'runtime'], true)) {
    throw new RuntimeException('Expected shared or runtime verification mode.');
}
...
$expected = $mode === 'shared' ? array_merge($runtime, array_keys($spec['tables'])) : $runtime;
