...
final class ResetRetention
{
    ...
    public const GROUPS = [
        ...
        'preserved_evidence' => ['backup_restore_rehearsals', 'backup_manifests', 'document_delivery_attempts', 'super_admins', 'backup_records', 'pos_audit_logs', 'admin_audit_logs', 'identity_audit_events', 'team_member_audit_events', 'admin_identity_mappings', 'integration_events', 'migration_runs', 'migration_identity_map', 'migration_quarantine', 'migration_reconciliation', 'migration_source_history', 'legacy_integration_requests', 'legacy_integration_events'],
