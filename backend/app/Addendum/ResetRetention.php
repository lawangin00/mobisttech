...
final class ResetRetention
{
    ...
    public const GROUPS = [
        'transactional' => ['notification_delivery_attempts', 'repair_events', 'repair_payment_links', 'repair_part_consumptions', 'repair_estimate_approvals', 'repair_estimate_lines', 'repair_estimates', 'repair_jobs', 'loyalty_claim_lots', 'loyalty_earn_lots', 'loyalty_entries', 'loyalty_claims', 'loyalty_accounts', 'promotion_events', 'promotion_claims', 'claim_events', 'claims', 'invoices', 'sales', 'reservation_allocations', 'reservation_lines', 'reservations', 'order_items', 'website_order_payment_terms', 'orders', 'payments',
            'project_events', 'project_files', 'project_proposal_milestones', 'project_proposals', 'client_projects', 'service_request_files', 'service_request_events', 'service_request_selections', 'service_request_details', 'service_request_rate_buckets', 'product_reviews', 'project_quotes', 'service_requests', 'payment_receipts', 'returns', 'return_lines', 'refunds', 'pos_tender_allocations', 'pos_settlement_events', 'pos_refund_allocations', 'cash_sessions', 'cash_entries', 'monetary_adjustments', 'project_milestone_identities', 'order_item_milestones'],
        ...
        'business_content' => ['wishlist_items', 'product_notification_subscriptions', 'notification_preferences', 'digital_service_packages', 'digital_service_addons', 'site_page_service_links', 'site_page_revisions', 'cms_policy_revisions', 'cms_policies', 'cms_route_redirects', 'software_releases', 'software_product_revisions', 'software_products', 'digital_services', 'site_managed_pages', 'site_navigation_items', 'site_media_assets', 'site_media_usages', 'customers', 'customer_source_links'],
        'configuration' => ['configuration_recovery_snapshots', 'digital_consultation_settings', 'document_template_revisions', 'repair_settings', 'loyalty_configurations', 'promotions', 'promotion_products', 'promotion_categories', 'pos_configuration_revisions', 'site_configuration_revisions', 'pos_master_data_options', 'pos_master_data_usages', 'pos_media_assets', 'pos_media_usages',
        ...
        'preserved_evidence' => ['reset_operations', 'backup_restore_rehearsals', 'backup_manifests', 'document_delivery_attempts', 'super_admins', 'backup_records', 'pos_audit_logs', 'admin_audit_logs', 'identity_audit_events', 'team_member_audit_events', 'admin_identity_mappings', 'owner_offline_recovery_codes', 'integration_events', 'migration_runs', 'migration_identity_map', 'migration_quarantine', 'migration_reconciliation', 'migration_source_history', 'legacy_integration_requests', 'legacy_integration_events'],
        'runtime' => ['notification_rate_buckets', 'cache', 'cache_locks', 'jobs', 'job_batches', 'failed_jobs', 'sessions', 'migrations', 'account_sessions', 'password_reset_tokens',
