...
type Data = { area: Area; outlet: { id: string; name: string }; can_send_documents: boolean; invoices: Invoice[]; customers: Customer[]; claims: ClaimRow[]; sale_candidates: SaleCandidate[]; report: Report | null; report_presentation:{sections:ReportSection[]}|null; pagination: Paging | null; warranty_intake_category: string | null };
