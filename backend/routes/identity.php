...
Route::get('/api/v1/orders/{order}/signed', [CustomerApiController::class, 'signedOrder'])
    ->middleware(['signed', 'throttle:api-customer'])->name('api.customer.orders.signed');
...
Route::prefix('/internal/admin')->middleware(['identity', 'identity.auth'])->group(function () {
    ...
    Route::get('/pos/inventory/acquisitions/{acquisition}/evidence/{side}', [PosTransactionController::class, 'acquisitionDocument'])->whereNumber('acquisition')->whereIn('side', ['front', 'back'])->defaults('identity_realm', 'admin')->middleware(['throttle:identity', 'identity.recent'])->name('admin.pos.inventory.acquisitions.evidence.read');
    Route::post('/pos/inventory/acquisitions/{acquisition}/evidence/{side}', [PosTransactionController::class, 'acquisitionDocumentAttach'])->whereNumber('acquisition')->whereIn('side', ['front', 'back'])->defaults('identity_realm', 'admin')->middleware(['throttle:identity', 'identity.recent'])->name('admin.pos.inventory.acquisitions.evidence.attach');
    Route::post('/pos/inventory/products/{product}/archive', [PosTransactionController::class, 'archiveProduct'])->whereUuid('product')->defaults('identity_realm', 'admin')->middleware(['throttle:identity', 'identity.recent'])->name('admin.pos.inventory.products.archive');
    ...
    Route::get('/website-audit', [WebsiteAuditController::class, 'index'])->defaults('identity_realm', 'admin')->name('admin.website.audit');
    Route::get('/website-performance', [WebsitePerformanceController::class, 'page'])->defaults('identity_realm', 'admin')->name('admin.website.performance');
    Route::get('/website-performance/data', [WebsitePerformanceController::class, 'summary'])->defaults('identity_realm', 'admin')->name('admin.website.performance.data');
    Route::get('/website-performance/orders.csv', [WebsitePerformanceController::class, 'csv'])->defaults('identity_realm', 'admin')->name('admin.website.performance.csv');
    ...
    Route::get('/integrations/google_drive/backups', [IntegrationController::class, 'backupHistory'])->defaults('identity_realm', 'admin')->name('admin.integrations.backups.history');
    Route::get('/integrations/google_drive/backups/{backup}/download', [IntegrationController::class, 'backupDownload'])->whereNumber('backup')->defaults('identity_realm', 'admin')->name('admin.integrations.backups.download');
    Route::delete('/integrations/google_drive/backups/{backup}', [IntegrationController::class, 'backupDelete'])->whereNumber('backup')->defaults('identity_realm', 'admin')->middleware(['throttle:identity', 'identity.recent'])->name('admin.integrations.backups.delete');
